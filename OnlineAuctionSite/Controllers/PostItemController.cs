...
namespace OnlineAuctionSite.Controllers
{
    public class PostItemController : Controller
    {
        ...
        // GET: PostItem
        [HttpPost]
        public ActionResult Index(string name,int category,double price, string description,HttpPostedFileBase file, DateTime dates)
        {
            ...
            q.CommandText = "INSERT INTO [Item](category_id,user_id,name,description,price,imagefile, dates,sold,delivered) VALUES('"+category+"','"+loggeduser.id+"','"+name.Replace("'", "''") + "','"+description.Replace("'","''")+"','"+price+"','"+imagefile+"', '"+dates+"', '0','0');";
